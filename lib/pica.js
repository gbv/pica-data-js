...
import { parseStream, parseAll } from "./stream.js"
import { PicaPath } from "./picapath.js"

export { PicaPath, parseStream, parseAll }
...
import { PicaLineReader } from "./stream.js"

// legacy interface
export const parsePicaLine = (line, options={}) => {    
  const format = options.annotated ? "annotated" : "plain"
  const reader = new PicaLineReader({ format, ...options })
  try {
